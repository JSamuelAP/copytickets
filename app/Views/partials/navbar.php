    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('public/DestruirSesion') ?>" class="nav-link">Cerrar Sesion</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="<?= base_url('public/organizador/perfil/'. $_SESSION['datos']['id'])?>" class="nav-link">Dashboard</a>
                </li>
                <li class="nav-item">
                    <a href="<?= base_url('public/DestruirSesion') ?>" class="nav-link">Cerrar Sesion</a>
                </li>
