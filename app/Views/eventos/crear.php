...
<form id="CrearEvento" action="<?= base_url('public/eventos/generar') ?>"
        ...
        <div class="row row-gap-3 mt-4">
            ...
            <div class="col-12 col-sm-6 col-lg-2">
                ...
                <input type="number" class="form-control" name="precio"
                       id="precio" required placeholder="$0.00 MXN"
                       min="0">
            </div>
    ...
    <section class="mt-5">
        ...
        <div class="row mt-4">
            <div class="col-12 col-sm-6 col-md-4 offset-md-2">
                <p>Crea las credenciales que usaran los usuarios encargados de
                    escanear los boletos desde la App
                    móvil.</p>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <div class="mb-3">
                    <input type="text" class="form-control"
                           name="usuario_escaner"
                           placeholder="Nombre de usuario"
                           required>
                </div>
                <div class="mb-3">
                    <input type="password" class="form-control"
                           name="password_escaner" placeholder="Contraseña"
                           required>
                </div>
            </div>
            <input type="hidden" name="organizador_id" id="organizador_id"
    ...
    <div class="text-center my-5">
        <a
                href="<?= base_url('public/organizador/perfil/' . $organizador['id']) ?>"
