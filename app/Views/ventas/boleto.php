...
<div class="d-flex justify-content-center mt-3 mb-5">
    <div class="card" style="width: 20rem;">
        ...
        >
            ...
            <p class="mb-0"><i class="bi bi-geo-alt-fill me-1"></i>Foro del lago, León Gto</p>
            <p class="mb-4"><i class="bi bi-calendar-check-fill me-1"></i>Sábado 30 septiembre, 21:00</p>
            <p class="mb-5">
