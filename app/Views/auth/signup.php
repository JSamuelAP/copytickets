        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6">
                ...
                <form id="Registrar" method="post"
                      action="<?= base_url('public/Crud_User/contInsert_User') ?>">
                    <div class="row g-3 mb-3">
                        ...
                        <textarea class="form-control" rows="3"
                                  placeholder="Descripción. Cuentanos más acerca de ti"
                                  name="descripcion"></textarea>
                        </div>
                    </div>
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary btn-lg"
                                id="Formulario">Crear cuenta
                        </button>
                    </div>
                    <p class="text-center mt-2">¿Ya tienes una cuenta? <a
